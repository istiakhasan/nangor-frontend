...
const CartPage = () => {
  ...
  const totalItems = cartItems?.cart?.reduce((total, item) => total + item.quantity, 0);
      ...
      <div className=" mx-auto">
        ...
        <div className="mb-8 p-4 bg-white rounded-lg shadow-sm">
          <div className="flex items-center text-sm text-gray-600">
            <Link href="/" className="flex items-center hover:text-[#4d321d] transition-colors">
        ...
        <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-gray-600">
              There are <span className="font-semibold text-[#4d321d]">{totalItems}</span> products in your cart
            </p>
          </div>
          <button 
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50 border-b border-gray-200">
                      <tr>
                        ...
                        <th className="py-4 px-6 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Quantity</th>
                        <th className="py-4 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Subtotal</th>
                        <th className="py-4 px-6 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Remove</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200">
                      {cartItems?.cart.map((product, idx) => (
                        <tr key={idx} className="hover:bg-gray-50 transition-colors">
                          <td className="py-4 px-6">
                            <div className="flex items-center">
                              ...
                              <div className="ml-4">
                                ...
                                <p className="text-xs text-gray-500 mt-1">{product?.category?.label}</p>
                              </div>
                            </div>
                          </td>
                          <td className="py-4 px-6">
                            <span className="text-sm font-medium text-gray-900">${Number(product?.salePrice).toFixed(2)}</span>
                          </td>
                          <td className="py-4 px-6">
                          ...
                          <td className="py-4 px-6">
                            <span className="text-sm font-medium text-[#4d321d]">
                    ...
                    <div key={idx} className="p-4">
                      <div className="flex items-start">
                        ...
                        <div className="ml-4 flex-1">
                          ...
                          <p className="text-sm text-gray-500 mt-1">${Number(product?.salePrice).toFixed(2)}</p>
                          
                          <div className="flex items-center justify-between mt-3">
                            <div className="flex items-center border border-gray-300 rounded-lg">
                              <button 
                                onClick={() => dispatch(incrementQuantityByInput({ value: product.quantity - 1, index: idx }))}
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-8">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex justify-between">
                    ...
                    <span className="text-xl font-bold text-[#4d321d]">${subtotal.toFixed(2)}</span>
                  </div>
                </div>
              </div>
              ...
              <button 
                ...
                className={`mt-8 w-full py-3 px-4 rounded-lg cursor-pointer font-medium transition-colors ${
                  cartItems.cart.length === 0 
                    ...
                    : 'bg-[#4d321d] text-white hover:bg-[#4d321d] shadow-md hover:shadow-lg'
                }`}
              >
                Proceed to Checkout
              ...
              <div className="mt-6 text-center">
                <Link href="/" className="inline-flex items-center text-sm text-[#4d321d] hover:text-indigo-800">
